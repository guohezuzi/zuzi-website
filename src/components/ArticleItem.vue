<template>
  <div class="article-item">
    ...
    <div class="article-wrap">
      <div class="article">
        <p class="article-item-title">{{article.articleTitle}}</p>
        <p>{{article.articleLastUpdateTime}} /
          <router-link class="article-tag" v-for="tag in article.articleTags" :key="tag" :to="'/category/'+tag">{{tag}}</router-link>
